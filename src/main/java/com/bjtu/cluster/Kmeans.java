...
public class Kmeans {
    ...
    private float distance(float[] element, float[] center) {
        ...
        /*
         * float x = element[0] - center[0]; float y = element[1] - center[1];
    ...
    private float errorSquare(float[] element, float[] center) {
        ...
        /*
         * float x = element[0] - center[0]; float y = element[1] - center[1];
         * float errSquare = x * x + y * y; return errSquare;
         */
    }
    ...
    private void setNewCenter() {
        for (int i = 0; i < k; i++) {
            ...
            if (n != 0) {
                ...
                /*
                 * newCenter[0] = newCenter[0] / n; newCenter[1] = newCenter[1]
                 * / n;
                 */
